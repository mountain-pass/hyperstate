...
public class StepDefs {
  ...
  class AccountBuilder {
    ...
    public CompletableFuture<Account> build(final String path)
      ...
      final String[] actionNames = entity.getActions().stream().map(a -> a.getLabel())
    ...
    public void setExpectedLinkAddress(final String rel, final String path) {
  ...
  public void a_Hyperstate_controller_at(final String beanName, final String path)
      throws Throwable {
    ...
    // check path
    final RequestMapping requestMapping = AnnotationUtils.findAnnotation(controller.getClass(),
  ...
  public void an_domain_entity_with(final String entityName, final Map<String, String> properties)
      throws Throwable {
  ...
  public void it_s_only_link_is_self_link_referencing(final String path) throws Throwable {
    currentAccountBuilder.setExpectedLinkAddress(Relationship.SELF, path);
  }

  @Then("^it will have a self link referencing \"([^\"]*)\"$")
  public void it_will_have_a_self_link_referencing(final String path) throws Throwable {
  ...
  public void it_will_have_no_links_apart_from(final String rel) throws Throwable {
  ...
  public void request_is_made_to_for_an(final String path, final String typeName) throws Throwable {
  ...
  public void the_controller_s_root_has_an_link_to_an_domain_entity(final String rel,
      final String typeName) throws Throwable {
    controller.getRoot().thenAcceptAsync(root -> {
      root.getEntities().thenAcceptAsync(entities -> {
        final Optional<EntityRelationship> match = entities.stream().filter(entityRel -> {
  ...
  public void the_response_will_be_an_domain_entity(final String type) throws Throwable {
  ...
  public void the_response_will_be_an_domain_entity_with(final String type,
    ...
    case "Account":
      assertThat(properties.keySet(), contains("username", "creationDate"));
      final AccountProperties entityProperties = (AccountProperties) currentEntity.getProperties();
